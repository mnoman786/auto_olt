  ...
  return (
    <AppLayout>
      <div className="relative">
        <div aria-hidden className="absolute inset-x-0 top-0 h-56 bg-linear-to-b from-amber-50/70 dark:from-amber-950/20 via-orange-50/40 dark:via-transparent to-transparent pointer-events-none" />
        <div className="relative p-6 max-w-4xl mx-auto">
        <Link href="/docs" className="inline-flex items-center gap-1.5 text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 mb-4 transition-colors">
          <ArrowLeft className="h-4 w-4" />
          Back to Documentation
        </Link>
        <div className="flex items-center gap-4 mb-2">
          <div className="w-12 h-12 rounded-2xl bg-linear-to-br from-amber-50 to-orange-100 dark:from-amber-900/30 dark:to-orange-900/30 flex items-center justify-center text-orange-600 dark:text-orange-400 shadow-sm shrink-0">
            <Layers className="h-6 w-6" />
          </div>
          <div>
            <p className="text-xs font-semibold uppercase tracking-wider text-orange-600/80 dark:text-orange-400/80">Guide</p>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mt-0.5">MikroTik Port Forwarding</h1>
        ...
        <Section title="MikroTik Router — Port Forwarding Setup" icon={Layers} color="bg-orange-500">
          ...
          <div className="mt-2">
            <p className="font-semibold text-gray-800 dark:text-gray-200 mb-3 flex items-center gap-2">
              <span className="bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-400 text-xs px-2 py-0.5 rounded-full font-bold">Method A</span>
              Using Winbox (GUI)
            </p>
            <div className="space-y-6">
              ...
              <Step num={2} title="Forward SNMP — UDP 161">
                ...
                <div className="bg-gray-50 dark:bg-gray-700/60 rounded-lg p-3 space-y-1 font-mono text-xs mt-2">
                  ...
                  <div className="flex justify-between"><span className="text-gray-500 dark:text-gray-400">Protocol:</span><span>udp</span></div>
                  <div className="flex justify-between"><span className="text-gray-500 dark:text-gray-400">Dst. Port:</span><span>161</span></div>
                  <div className="flex justify-between"><span className="text-gray-500 dark:text-gray-400">In. Interface:</span><span className="text-blue-600">ether1 (WAN interface)</span></div>
                </div>
                <p className="mt-2">Switch to the <strong>Action</strong> tab:</p>
                <div className="bg-gray-50 dark:bg-gray-700/60 rounded-lg p-3 space-y-1 font-mono text-xs mt-1">
                  ...
                  <div className="flex justify-between"><span className="text-gray-500 dark:text-gray-400">To Ports:</span><span>161</span></div>
                </div>
              ...
              <Step num={3} title="Forward Telnet — TCP 23">
                ...
                <div className="bg-gray-50 dark:bg-gray-700/60 rounded-lg p-3 space-y-1 font-mono text-xs mt-2">
                  <div className="flex justify-between"><span className="text-gray-500 dark:text-gray-400">Chain:</span><span>dstnat</span></div>
                  <div className="flex justify-between"><span className="text-gray-500 dark:text-gray-400">Protocol:</span><span>tcp</span></div>
                  <div className="flex justify-between"><span className="text-gray-500 dark:text-gray-400">Dst. Port:</span><span>23</span></div>
                  <div className="flex justify-between"><span className="text-gray-500 dark:text-gray-400">In. Interface:</span><span className="text-blue-600">ether1 (WAN interface)</span></div>
                </div>
                ...
                <div className="bg-gray-50 dark:bg-gray-700/60 rounded-lg p-3 space-y-1 font-mono text-xs mt-1">
                  <div className="flex justify-between"><span className="text-gray-500 dark:text-gray-400">Action:</span><span>dst-nat</span></div>
                  <div className="flex justify-between"><span className="text-gray-500 dark:text-gray-400">To Addresses:</span><span className="text-blue-600">{'<OLT LAN IP e.g. 192.168.1.1>'}</span></div>
                  <div className="flex justify-between"><span className="text-gray-500 dark:text-gray-400">To Ports:</span><span>23</span></div>
                </div>
          ...
          <div className="mt-6 pt-4 border-t border-gray-100 dark:border-gray-700">
            <p className="font-semibold text-gray-800 dark:text-gray-200 mb-3 flex items-center gap-2">
              <span className="bg-gray-800 dark:bg-gray-700 text-white text-xs px-2 py-0.5 rounded-full font-bold">Method B</span>
              Using CLI / Terminal
            </p>
            <div className="space-y-4">
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Forward UDP 161 (SNMP) to OLT:</p>
              ...
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Forward TCP 23 (Telnet) to OLT:</p>
                <CodeBlock code={`/ip firewall nat add chain=dstnat protocol=tcp dst-port=23 \\\n  in-interface=ether1 action=dst-nat \\\n  to-addresses=192.168.1.1 to-ports=23`} />
              </div>
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Disable MikroTik's own Telnet service:</p>
                <CodeBlock code={`/ip service set telnet disabled=yes`} />
              </div>
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Verify rules were added:</p>
        ...
        <div className="mt-6 p-4 bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-800 rounded-xl flex items-start gap-3">
          <CheckCircle2 className="h-5 w-5 text-indigo-500 shrink-0 mt-0.5" />
          <div>
            <p className="font-medium text-indigo-800 dark:text-indigo-300 text-sm">Port forwarding not working?</p>
